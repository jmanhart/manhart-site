...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Blog;
  const posts = (await Astro2.glob(/* #__PURE__ */ Object.assign({"./blog/dark-mode.md": () => import('./dark-mode_ac55ed5a.mjs').then(n => n.d),"./blog/sentry-metal.md": () => import('./sentry-metal_698077a6.mjs')}), () => "./blog/*.{md,mdx}")).sort(
